...
VideoGuard 是一个基于深度学习和多模态融合技术的智能视频内容检测系统，能够自动识别视频中的有害内容，包括暴力、色情、血腥、吸烟等违规行为，同时支持音频语音识别和图像文字提取，检测语音和文字中的违规内容，并且生成详细检测结果参数的pdf报告，可以对违规链接视频向相应平台自动举报，提供全方位的内容安全检测服务。
|bloody video| porn video|
|---|---|
| ![血腥视频](img/bloody_show.png) | ![色情视频](img/porn_show.png) |
